...
[ApiVersion("2.0")]
[Authorize]
[Route("v{version:apiVersion}/estoques-medicamento")]
public class EstoqueMedicamentoController : ControllerBase
{
    private readonly EstoqueMedicamentoService _service;

    public EstoqueMedicamentoController(EstoqueMedicamentoService service)
    {
        _service = service;
    }
    ...
    [HttpGet]
    [MapToApiVersion("2.0")]
    public async Task<IActionResult> FindAllV2([FromQuery] EstoqueMedicamentoFilter filter)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EstoqueMedicamentoCreateDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(string id, [FromBody] EstoqueMedicamentoUpdateDto dto)
    {
